...
class BytessourceS3(Bytessource):
    ...
    def __init__(self, config:dict, aws_name_region, name_bucket, prefix_root, list_key=[], is_public=False) -> None:
    ...
    def set_public(self, is_public) -> None:
        self._is_public = is_public
    ...
    def from_dict(config:dict, dict_bytessource) -> 'BytessourceS3':
        ...
        if 'is_public' in dict_bytessource:
            return BytessourceS3( 
                config,
